...
export class TaharahListComponent implements OnInit {
    ...
    viewOptions = [
        {label: 'ממתינים לקליטה', value: TaharahStatusEnum.Pending},
        {label: 'פעילים בטהרה', value: TaharahStatusEnum.InProgress},
        {label: 'שוחררו מטהרה', value: TaharahStatusEnum.Complete}
    ];

    selectedDeceased: TaharahList | null = null;

    viewMode: TaharahStatusEnum = TaharahStatusEnum.Pending;
    ...
    protected readonly TaharahStatusEnum = TaharahStatusEnum;
}
